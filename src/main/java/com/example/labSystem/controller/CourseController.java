...
public class CourseController extends BaseController {
    ...
    @RequestMapping(value = "/queryCourseByUserList", method = RequestMethod.POST)
    public void queryCourseByUserList(HttpServletRequest request, HttpServletResponse response,
                                      @RequestBody CommonRequestQto qto) throws Exception {
        List<CourseDro> resList = courseService.queryCourseByUserList(qto.getList());
